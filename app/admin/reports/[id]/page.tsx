      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
          <a
            ...
            className="px-3 py-2 text-sm border border-gray-light rounded-sm hover:bg-off-white transition-colors"
          >
            PDF
          </a>
          <Link
          ...
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="px-3 sm:px-4 py-2 text-sm bg-gold text-black font-medium rounded-sm hover:bg-gold-dark transition-colors disabled:opacity-50"
          >
              ...
              {isSearching ? (
                ...
                <div className="space-y-3">
                  ...
                  {filteredResults.map((result) => (
                    <label
                      key={result.vin}
                      className={`block p-3 border rounded-sm cursor-pointer transition-colors ${
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <input
                          ...
                          className="w-4 h-4 mt-1 rounded border-gray-light text-gold focus:ring-gold flex-shrink-0"
                        />
                        <div className="hidden sm:block w-24 h-16 flex-shrink-0 rounded-sm overflow-hidden bg-gray-100 relative">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 text-xs mt-1 flex-wrap">
                            {result.sourceUrl && (
                              ...
                              >
                                <span className="truncate max-w-[100px] sm:max-w-[150px]">{result.source}</span>
